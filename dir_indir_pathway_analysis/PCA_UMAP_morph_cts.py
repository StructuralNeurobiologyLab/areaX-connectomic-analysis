...
if __name__ == '__main__':
    ...
    fontsize = 20
    f_name = f"cajal/scratch/users/arother/bio_analysis_results/dir_indir_pathway_analysis/240220_j0251{version}_%s_%s_morph_PCA_{fontsize}" % (
    ...
    #morph_data_path = 'cajal/scratch/users/arother/bio_analysis_results/dir_indir_pathway_analysis/240220_j0251v6_GPe_i_myelin_mito_radius_mcl200_fs10_med1'
