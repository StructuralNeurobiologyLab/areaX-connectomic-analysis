if __name__ == '__main__':
    ...
    gpi_ct = 7
    msn_ct = 2
    f_name = "cajal/scratch/users/arother/bio_analysis_results/dir_indir_pathway_analysis/230808_j0251v5_MSN_connGP_comparison_mcl_%i_ax%i_synprob_%.2f_ranksums" % (cl_cell, cl_ax, syn_prob)
