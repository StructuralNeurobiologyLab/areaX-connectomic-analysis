if __name__ == '__main__':
    ...
    gpi_ct = 7
    msn_ct = 2
    f_name = "cajal/scratch/users/arother/bio_analysis_results/dir_indir_pathway_analysis/230811_j0251v5_MSN_connGP_comparison_mcl_%i_ax%i_synprob_%.2f_ranksums_med" % (cl_cell, cl_ax, syn_prob)
    ...
    MSN_onlyGPe_MSN_both_resultsfolder = synapses_between2cts(sd_synssv, celltype1=2, celltype2=2,
                                                              ...
                                                              wd = global_params.wd, version = version)
