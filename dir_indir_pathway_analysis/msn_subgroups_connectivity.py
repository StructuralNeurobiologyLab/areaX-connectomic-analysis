...
if __name__ == '__main__':
    ...
    annot = True
    ngf_subgroups = False
    f_name = "cajal/scratch/users/arother/bio_analysis_results/general/230814_j0251v5_cts_percentages_msn_subgroups_mcl_%i_ax%i_synprob_%.2f_%s_annot_bw_fs_%i_ngfsg_%i" % (
