...
#                      FS=8, LTS=9, NGF=10
    ...
    input = [[cellid, min_comp_len, full_cell_dict, spiness] for cellid in cellids]
...
def compare_compartment_volume_ct(celltype1, filename, celltype2= None, percentile = None, filename1 = None, filename2 = None, min_comp_len = 100, label_ct1 = None, label_ct2 = None, color_key = None):
    '''
