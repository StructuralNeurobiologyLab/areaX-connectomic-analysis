...
if __name__ == '__main__':
    ...
    fontsize = 20
    f_name = f"cajal/scratch/users/arother/bio_analysis_results/dir_indir_pathway_analysis/250711_j0251{version}_{ct_str}_autapse_comp_mcl_%i_ms_%.1f_%i" % (
    ...
    morph_info_path = 'cajal/scratch/users/arother/bio_analysis_results/general/' \
                      '250711_j0251v6_ct_morph_analyses_newmergers_mcl_200_ax200_TeBKv6MSNyw_fs20npca1_umap5_a0.5_synmives/' \
                       'ct_morph_df.csv'
