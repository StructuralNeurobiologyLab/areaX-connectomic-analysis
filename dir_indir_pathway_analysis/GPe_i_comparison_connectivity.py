...
if __name__ == '__main__':
    ...
    gpe_ct = 6
    gpi_ct = 7
    f_name = "cajal/scratch/users/arother/bio_analysis_results/dir_indir_pathway_analysis/220505_j0251v5_GPe_i_comparison_mcl_%i_synprob_%.2f" % (comp_length_cell, syn_prob)
