...
if __name__ == '__main__':
    ...
    color_key = 'TePkBrNGF'
    fontsize = 20
    f_name = f"cajal/scratch/users/arother/bio_analysis_results/single_vesicle_analysis/250313_j0251{version}_ct_syn_fraction_closemembrane_mcl_%i_ax%i_dt_%i_st_%i_%i_%s" % (
