...
if __name__ == '__main__':
    ...
    f_name = f"cajal/scratch/users/arother/bio_analysis_results/dir_indir_pathway_analysis/241024_j0251{version}_GPe_i_myelin_mito_radius_newmerger_mcl%i_fs%i_med%i" % \
